...
* Script: [`get_soil.R`](https://github.com/sylvainschmitt/trollExp/blob/main/scripts/get_soilx.R)
...
* Script: [`extract_soil.R`](https://github.com/sylvainschmitt/trollExp/blob/main/scripts/extract_soil.R)
